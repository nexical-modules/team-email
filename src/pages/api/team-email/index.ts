...
export const GET = defineApi(
  async (context, actor) => {
    ...
    const result = await TeamEmailService.list({ where, take, skip, orderBy, select }, actor);
    ...
    // Analytics Hook
    await HookSystem.dispatch('teamEmail.list.viewed', {
      count: data.length,
...
export const POST = defineApi(
  async (context, actor) => {
    ...
    const result = await TeamEmailService.create(validated, select, actor);
